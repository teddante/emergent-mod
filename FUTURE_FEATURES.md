...
- Vanilla level-based damage, protection, and ignite-duration effects are covered through Mojang's native effect components at over-cap levels, avoiding a second Emergent multiplier on effects that already scale with level.
