...
- PR #6, `perf/finite-fluid-budget`, is stacked on PR #4 and adds deterministic active finite-fluid tick budgeting plus diagnostics for budget claims and deferrals.
...
- Deterministic active finite-fluid tick budget that defers excess active cells instead of dropping work, with profiler counters for budget claims and deferrals.
